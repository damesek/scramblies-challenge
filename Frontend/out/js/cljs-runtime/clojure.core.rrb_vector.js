...
var len__4864__auto___38280 = arguments.length;
var i__4865__auto___38281 = (0);
while(true){
if((i__4865__auto___38281 < len__4864__auto___38280)){
args_arr__4885__auto__.push((arguments[i__4865__auto___38281]));

var G__38282 = (i__4865__auto___38281 + (1));
i__4865__auto___38281 = G__38282;
continue;
} else {
}
break;
...
/** @this {Function} */
(clojure.core.rrb_vector.catvec.cljs$lang$applyTo = (function (seq38220){
var G__38221 = cljs.core.first(seq38220);
var seq38220__$1 = cljs.core.next(seq38220);
var G__38222 = cljs.core.first(seq38220__$1);
var seq38220__$2 = cljs.core.next(seq38220__$1);
var G__38223 = cljs.core.first(seq38220__$2);
var seq38220__$3 = cljs.core.next(seq38220__$2);
var G__38224 = cljs.core.first(seq38220__$3);
var seq38220__$4 = cljs.core.next(seq38220__$3);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38221,G__38222,G__38223,G__38224,seq38220__$4);
}));
...
default:
var args_arr__4885__auto__ = [];
var len__4864__auto___38291 = arguments.length;
var i__4865__auto___38292 = (0);
while(true){
if((i__4865__auto___38292 < len__4864__auto___38291)){
args_arr__4885__auto__.push((arguments[i__4865__auto___38292]));

var G__38293 = (i__4865__auto___38292 + (1));
i__4865__auto___38292 = G__38293;
continue;
} else {
}
break;
...
var arr__38272 = [];
return (new clojure.core.rrb_vector.rrbt.Vector(0,(5),cljs.core.PersistentVector.EMPTY_NODE,arr__38272,null,null));
}));
...
return (new clojure.core.rrb_vector.rrbt.Vector(1,(5),cljs.core.PersistentVector.EMPTY_NODE,arr__38273,null,null));
}));

(clojure.core.rrb_vector.vector.cljs$core$IFn$_invoke$arity$2 = (function (x1,x2){
var arr__38274 = [null,null];
(arr__38274[(0)] = x1);

(arr__38274[(1)] = x2);

return (new clojure.core.rrb_vector.rrbt.Vector(2,(5),cljs.core.PersistentVector.EMPTY_NODE,arr__38274,null,null));
}));

(clojure.core.rrb_vector.vector.cljs$core$IFn$_invoke$arity$3 = (function (x1,x2,x3){
var arr__38275 = [null,null,null];
(arr__38275[(0)] = x1);
...
return (new clojure.core.rrb_vector.rrbt.Vector(3,(5),cljs.core.PersistentVector.EMPTY_NODE,arr__38275,null,null));
}));

(clojure.core.rrb_vector.vector.cljs$core$IFn$_invoke$arity$4 = (function (x1,x2,x3,x4){
var arr__38276 = [null,null,null,null];
(arr__38276[(0)] = x1);
...
return (new clojure.core.rrb_vector.rrbt.Vector(4,(5),cljs.core.PersistentVector.EMPTY_NODE,arr__38276,null,null));
}));
...
/** @this {Function} */
(clojure.core.rrb_vector.vector.cljs$lang$applyTo = (function (seq38259){
var G__38260 = cljs.core.first(seq38259);
var seq38259__$1 = cljs.core.next(seq38259);
var G__38261 = cljs.core.first(seq38259__$1);
var seq38259__$2 = cljs.core.next(seq38259__$1);
var G__38262 = cljs.core.first(seq38259__$2);
var seq38259__$3 = cljs.core.next(seq38259__$2);
var G__38263 = cljs.core.first(seq38259__$3);
var seq38259__$4 = cljs.core.next(seq38259__$3);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38260,G__38261,G__38262,G__38263,seq38259__$4);
}));
