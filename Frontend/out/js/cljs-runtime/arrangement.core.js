...
if((o === (0))){
var G__37226 = cljs.core.next(xs);
var G__37227 = cljs.core.next(ys);
xs = G__37226;
ys = G__37227;
continue;
} else {
...
if((size_diff === (0))){
return arrangement.core.compare_seqs(cljs.core.sort.cljs$core$IFn$_invoke$arity$1(a),cljs.core.sort.cljs$core$IFn$_invoke$arity$1(b));
} else {
return size_diff;
}
} else {
