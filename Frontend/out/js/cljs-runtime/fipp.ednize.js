...
var fipp$ednize$IEdn$_edn$dyn_37989 = (function (x){
...
return fipp$ednize$IEdn$_edn$dyn_37989(x);
}
});
...
return cljs.core.tagged_literal(new cljs.core.Symbol(null,"js","js",-886355190,null),cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4652__auto__ = (function fipp$ednize$edn_$_iter__37873(s__37874){
return (new cljs.core.LazySeq(null,(function (){
var s__37874__$1 = s__37874;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__37874__$1);
if(temp__5804__auto__){
var s__37874__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__37874__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__37874__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__37876 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__37875 = (0);
while(true){
if((i__37875 < size__4651__auto__)){
var k = cljs.core._nth(c__4650__auto__,i__37875);
cljs.core.chunk_append(b__37876,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(x[k])], null));

var G__38032 = (i__37875 + (1));
i__37875 = G__38032;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__37876),fipp$ednize$edn_$_iter__37873(cljs.core.chunk_rest(s__37874__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__37876),null);
}
} else {
var k = cljs.core.first(s__37874__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(x[k])], null),fipp$ednize$edn_$_iter__37873(cljs.core.rest(s__37874__$2)));
}
} else {
return null;
}
