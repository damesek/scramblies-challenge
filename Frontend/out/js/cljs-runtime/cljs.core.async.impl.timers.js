...
var i_32304 = (self__.level + (1));
while(true){
if((i_32304 <= (new_level + (1)))){
(update[i_32304] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_32306 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_32306[i]));
} else {
x__$2.forward.push((((i < links_32306.length))?(links_32306[i]):null));
}

if((i < links_32306.length)){
(links_32306[i] = x__$2);
} else {
links_32306.push(x__$2);
}
...
var i_32312 = (0);
while(true){
if((i_32312 <= self__.level)){
var links_32314 = (update[i_32312]).forward;
if((x__$1 === (((i_32312 < links_32314.length))?(links_32314[i_32312]):null))){
(links_32314[i_32312] = (x__$1.forward[i_32312]));

var G__32315 = (i_32312 + (1));
i_32312 = G__32315;
continue;
} else {
var G__32316 = (i_32312 + (1));
i_32312 = G__32316;
continue;
}
} else {
